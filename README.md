# ky1eBot
Version 1.2.1-0-public

A basic discord bot made with discord.js

My first ever discord bot using the discord.js framework.

So far it only has 9 basic commands.
Will update as I develop more commands.

Base bot prefix is "kyle$"

## List of commands
    changePrefix - Changes bot's prefix (per guild).
    restorePrefix - restores bot's prefix back to default "kyle$"
